    ...
    <div className='px-4 sm:px-20 xl:px-32 py-24'>
      ...
      <div className='flex flex-wrap mt-10 justify-center'>
        {dummyTestimonialData.map((testimonial) => (
          <div key={testimonial.name} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
            ...
            <div className='flex items-center gap-4'>
              <Image src={testimonial.image} className='w-12 h-12 object-cover rounded-full' alt={`${testimonial.name} avatar`} width={48} height={48} unoptimized />
